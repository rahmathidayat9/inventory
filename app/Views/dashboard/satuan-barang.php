                    ...
                    <div class="modal-body">
                        <form id="submitForm">
                            <div class="form-group">
                                ...
                                <input required type="hidden" name="satuan_barang_id" id="satuan_barang_id" class="form-control">
                                <input required type="text" name="satuan" id="satuan" class="form-control">
                            </div>
                    </div>
...
<script>
    $(document).ready( function () {
        ...
        let datatable = $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?=  base_url() ?>/dashboard/list-satuan-barang',
            order: [],
            columnDefs: [
        ...
        $("#addBtn").click(function() {
            removeInputValues(['satuan_barang_id', 'satuan'])
            $("#type").val('insert')
        ...
        $(document).on("click", "#editBtn", function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?= base_url() ?>/dashboard/edit-satuan-barang",
                data: {
                    id: id
                },
                dataType: "JSON",
                success: function (response) {
                    ...
                    $("#satuan_barang_id").val(rak.id)
                    $("#satuan").val(rak.satuan)
                }
            });
        })
        ...
        $("#submitForm").submit(function(e) {
            ...
            if (type == 'insert') {
                url = "<?= base_url() ?>/dashboard/insert-satuan-barang"
            } else {
                url = "<?= base_url() ?>/dashboard/update-satuan-barang"
            }
        ...
        $("#deleteAllBtn").click(function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>/dashboard/delete-bulk-satuan-barang",
                        data: {
                            id: checked.join(',')
                        },
                        dataType: "JSON",
        ...
        $(document).on('click', '#deleteBtn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>/dashboard/delete-satuan-barang",
                        data: {
                            id: id,
                        },
                        dataType: "JSON",
