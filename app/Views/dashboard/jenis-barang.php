                    ...
                    <div class="modal-body">
                        <form id="submitForm">
                            <div class="form-group">
                                ...
                                <input required type="hidden" name="jenis_barang_id" id="jenis_barang_id" class="form-control">
                                <input required type="text" name="jenis" id="jenis" class="form-control">
                            </div>
                    </div>
...
<script>
    $(document).ready( function () {
        ...
        let datatable = $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?=  base_url() ?>/dashboard/list-jenis-barang',
            order: [],
            columnDefs: [
        ...
        $("#addBtn").click(function() {
            removeInputValues(['jenis_barang_id', 'jenis'])
            $("#type").val('insert')
        ...
        $(document).on("click", "#editBtn", function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?= base_url() ?>/dashboard/edit-jenis-barang",
                data: {
                    id: id
                },
                dataType: "JSON",
        ...
        $("#submitForm").submit(function(e) {
            ...
            if (type == 'insert') {
                url = "<?= base_url() ?>/dashboard/insert-jenis-barang"
            } else {
                url = "<?= base_url() ?>/dashboard/update-jenis-barang"
            }
        ...
        $("#deleteAllBtn").click(function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>/dashboard/delete-bulk-jenis-barang",
                        data: {
                            id: checked.join(',')
                        },
                        dataType: "JSON",
        ...
        $(document).on('click', '#deleteBtn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>/dashboard/delete-jenis-barang",
                        data: {
                            id: id,
                        },
                        dataType: "JSON",
