                    ...
                    <div class="modal-body">
                        <form id="submitForm">
                            <div class="form-group">
                                ...
                                <input required type="hidden" name="rak_id" id="rak_id" class="form-control">
                                <input required type="text" name="rak_name" id="rak_name" class="form-control">
                            </div>
                    </div>
...
<script>
    $(document).ready( function () {
        ...
        let datatable = $('#dataTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?=  base_url() ?>/dashboard/list-rak',
            order: [],
            columnDefs: [
        ...
        $("#addBtn").click(function() {
            removeInputValues(['rak_id', 'rak_name'])
            $("#type").val('insert')
        ...
        $(document).on("click", "#editBtn", function() {
            ...
            $.ajax({
                type: "GET",
                url: "<?= base_url() ?>/dashboard/edit-rak",
                data: {
                    id: id
                },
                dataType: "JSON",
        ...
        $("#submitForm").submit(function(e) {
            ...
            if (type == 'insert') {
                url = "<?= base_url() ?>/dashboard/insert-rak"
            } else {
                url = "<?= base_url() ?>/dashboard/update-rak"
            }
        ...
        $("#deleteAllBtn").click(function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>/dashboard/delete-bulk-rak",
                        data: {
                            id: checked.join(',')
                        },
                        dataType: "JSON",
        ...
        $(document).on('click', '#deleteBtn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        url: "<?= base_url() ?>/dashboard/delete-rak",
                        data: {
                            id: id,
                        },
                        dataType: "JSON",
